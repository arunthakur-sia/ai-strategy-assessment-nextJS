...
export const SCORING_RUBRIC = `Score 1 (Critical/Absent): Element is absent or severely underdeveloped.
...
export const DEFAULT_RUBRIC: Record<string, Record<string, {
  ...
  P3: {
    ...
    'Working Capital Management': {
      critical:   'No working capital visibility; cash tied up in receivables/inventory with no management framework',
      weak:       'Working capital tracked but management is reactive; DSO/DIO significantly above sector',
      developing: 'Working capital metrics monitored; improvement initiatives underway but inconsistent',
      strong:     'Active working capital management; DSO/DIO/DPO optimized against sector benchmarks',
      excellent:  'Best-in-class working capital efficiency; cash conversion cycle continuously optimized',
    },
