          ...
          {PILLARS.map(p => {
            ...
            return (
              <button
                ...
                style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '10px', padding: '9px 16px', background: active ? `${p.color}12` : 'transparent', borderLeft: `3px solid ${active ? p.color : 'transparent'}`, border: 'none', borderRight: 'none', cursor: 'pointer', textAlign: 'left', transition: 'all 0.15s' }}
              >
