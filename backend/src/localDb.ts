/**
 * Local file-based storage — drop-in replacement for the Supabase client
 * when NEXT_PUBLIC_SUPABASE_URL is not set or unreachable.
 * Data is persisted to dist/data/local_db.json.
 */
import fs from 'fs'
